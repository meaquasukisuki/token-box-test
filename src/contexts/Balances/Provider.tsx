...
import { MAINNET_CHAIN_DATA, POLYGON_CHAIN_DATA, TEST_POLYGON_CHAIN_DATA } from 'utils/connectors'
...
const Provider: React.FC = ({ children }) => {
  ...
  const [eth2xLeverageIndexBalancePolygon, setEth2xLeverageIndexBalancePolygon] = useState<BigNumber>()
