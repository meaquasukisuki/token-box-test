...
export const Ethereum2xLeverageIndexP: ProductToken = {
  name: 'ETH 2X Leverage Index',
  symbol: 'ETH2X',
  address: undefined,
  polygonAddress: tokenAddresses.eth2xLeverageIndexAddress,
  image: 'https://set-core.s3.amazonaws.com/img/logos/default-set-token-icon.svg',
  // current no coin geko
  coingeckoId: 'index-coop-eth-2x-flexible-leverage-index-polygon',
  tokensetsId: 'eth2x',
  fees: {
    streamingFee: '2%',
