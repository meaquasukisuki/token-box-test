...
export const farmEth2XLeverageAddress = 
  process.env.REACT_APP_FARM_ETH_LEVERAGE_ADDRESS
export const farmBoxTokenAddress = 
  process.env.REACT_APP_FARM_ETH_LEVERAGE_ADDRESS
...
export const uniswapEth2xLeverageLpTokenAddress = 
  process.env.REACT_APP_UNISWAP_ETH_2X_LEVERAGE_LP_TOKEN_ADDRESS
export const uniswapBoxLpTokenAddress = 
  process.env.REACT_APP_UNISWAP_BOX_LP_TOKEN_ADDRESS
export const uniswapEth2USDCLpTokenAddress =
  process.env.REACT_APP_UNISWAP_ETH2USDC_LP_TOKEN_ADDRESS
...
export const eth2xLeverageIndexAddress = 
  process.env.REACT_APP_POLYGON_ETH2X_LEVERAGE_INDEX_ADDRESS
