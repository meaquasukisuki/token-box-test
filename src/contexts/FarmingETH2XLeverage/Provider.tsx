...
import {getEth2XLeverageTokenContract, stakeEth2xLeverageLpTokens} from 'index-sdk/boxStaking'
...
const Provider: React.FC = ({ children }) => {
  ...
  const { isApproved, isApproving, onApprove } = useApproval(
    ...
    getEth2XLeverageTokenContract(ethereum)
  )
  ...
  const handleStake = useCallback(
    async (amount: string) => {
      ...
      const transactionId = await stakeEth2xLeverageLpTokens(
